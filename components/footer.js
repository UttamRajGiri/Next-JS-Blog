...
export default function Footer() {
    return (
        <div className="footer-2 bg-gray-800 pt-6 md:pt-12 mt-20">
            <div className="container px-4 mx-auto">

                <div className="md:flex md:flex-wrap md:-mx-4 py-6 md:pb-12">

                    <div className="footer-info lg:w-1/3 md:px-4">
                        <h4 className="text-white text-2xl mb-4">Rumsan Group of Companies</h4>
                        <p className="text-gray-400">Rumsan Group is a diversified multi-business company. We are committed to supporting promising start-ups and investing in digital innovation.</p>
                        <div className="mt-4">
                    ...
                    <div className="md:w-2/3 lg:w-1/3 md:px-4 xl:pl-16 mt-12 lg:mt-0">
                        <div className="sm:flex">
                            ...
                            <div className="sm:flex-1 mt-4 sm:mt-0">
                                ...
                                <div>
                                    <a href="#" className="text-gray-400 py-1 block hover:underline">Blockchain</a>
                    ...
                    <div className="md:w-1/3 md:px-4 md:text-center mt-12 lg:mt-0">
                        ...
                        <button className="bg-twitter text-white hover:bg-indigo-700 rounded py-2 px-6 md:px-12 transition-colors duration-300">Explore</button>
                    </div>
                ...
                <div className="container px-4 mx-auto">
                    ...
                    <div className="md:flex md:-mx-4 md:items-center">
                        <div className="md:flex-1 md:px-4 text-center md:text-left">
                            <p className="text-white">&copy; <strong>Rumsan</strong></p>
                        </div>
